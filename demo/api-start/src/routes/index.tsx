...
import type { a } from "node_modules/@orpc/server/dist/shared/server.ChUyt5-i.d.mts";
			...
			<section className="relative py-20 px-6 text-center overflow-hidden">
				...
				<div className="relative max-w-5xl mx-auto">
					...
					<div className="flex flex-col items-center gap-4">
						...
						<a href='/api' className={buttonVariants({size: 'xl'})} >
						openapi (orpc)
						</a>
								<a href='/api/auth/reference' className={buttonVariants({size: 'xl'})} >
						openapi (better-auth)
						</a>
						</div>
						<p className="text-gray-400 text-sm mt-2">
							"Begin your API by TanStack Start journey by editing"{" "}
