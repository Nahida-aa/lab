...
# 缩略图
# from proj_base.settings.dev import THUMB_DIR, MEDIA_ROOT, BASE_DIR, AUTH_USER_MODEL
...
class Article(models.Model):
    ...
    author = models.ForeignKey(AUTH_USER_MODEL, verbose_name='作者', blank=True, on_delete=models.SET_NULL, null=True)
    def author_(self):
        return self.author
