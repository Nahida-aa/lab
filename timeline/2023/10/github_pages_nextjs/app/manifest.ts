...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    icons: [
      {
        "src": "/favicons/Nahida-48.webp",
        "sizes": "48x48", // 浏览器或操作系统的较小图标
        "type": "image/webp"
      },
      {
        "src": "/favicons/Nahida-72.webp",
        "sizes": "72x72", // Android 低分辨率设备的图标
        "type": "image/webp"
      },
      {
        "src": "/favicons/Nahida-96.webp",
        "sizes": "96x96", // Android 中等分辨率设备的图标
        "type": "image/webp"
      },
      {
        "src": "/favicons/Nahida-128.webp",
        "sizes": "128x128", // 桌面应用程序的图标
        "type": "image/webp"
      },
      {
        "src": "/favicons/Nahida-144.webp",
        "sizes": "144x144", // Windows 平台的 Pinned Tiles 图标
        "type": "image/webp"
      },      
      {
        src: '/favicons/Nahida-192.webp',
        sizes: '192x192', // PWA 的主屏幕图标（必须提供）
        type: 'image/webp',
      },
      {
        "src": "/favicons/Nahida-256.webp",
        "sizes": "256x256", // 高分辨率桌面图标
        "type": "image/webp"
      },
      {
        src: '/favicons/Nahida-512.webp',
