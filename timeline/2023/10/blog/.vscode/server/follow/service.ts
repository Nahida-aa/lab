...
//       .select()
//       .from(follow)
//       .where(and(eq(follow.followerId, targetId), eq(follow.targetId, authId)))
//       .limit(1);
...
//       .delete(follow)
//       .where(and(eq(follow.followerId, authId), eq(follow.targetId, targetId)))
//       .returning();

//     if (deletedFollow.length === 0)
//       throw AppErr(404, "Not following this user");
