...
// const inviteJoinProjectRoute = createRoute({
//   tags: ["project_member"],
//   method: "post",
//   path: "/projects/{id}/invite_member",
...
//   },
//   responses: {
//     200: jsonContent(inviteJoinProjectSchema, "邀请成功"),
//     403: jsonContent(messageObjectSchema("权限不足"), "无权限"),
//     404: jsonContent(messageObjectSchema("项目不存在"), "项目未找到"),
//   },
// });
// app.openapi(inviteJoinProjectRoute, async (c) => {
//   const { id } = c.req.valid("param");
//   const data = c.req.valid("json");
//   const session = c.var.session;
//   // 邀请成员
//   const result = await inviteJoinProject(
//     session.user.id,
//     id,
//     data.entityId,
//   );
