...
// import { user } from "@/api/auth/table";
...
//   createProjectSchema,
//   listUserSelfProjectQuerySchema,
//   listUserSelfProjectSchema,
// } from "../model";
// import { AppOpenAPI } from "@/api/app/create";
...
//   method: "post",
//   path: "/project/create",
//   description: "创建一个新的项目(mod、资源包、数据包等)",
...
//     // 查找项目 - 使用 Select API
//     const projectDetail = await getProject(slug);
