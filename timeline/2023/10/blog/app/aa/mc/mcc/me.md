...
人员:
1. 项目经理+ui (项目发起人)
2. 全栈(是我,另外还负责后台管理的开发)
3. 前端
4. 后端
5. 项目经理(我同学)

现在 1. 已经做好大致的原型, xd 做的 ui (并不是很好看)

好的，接下来你可以根据项目的需求和当前的进展，合理分配任务并推进项目。以下是一个详细的任务分配和推进计划，帮助你更好地管理和协调团队工作。
...
#### 1. 确定项目需求和功能列表
- **项目经理**：与所有相关方确认项目需求，确保所有功能和需求都被记录下来。
...
通过以上任务分配和推进计划，你可以合理分配任务并推进项目，确保项目的顺利进行和高质量交付。作为全栈开发人员，你可以利用你的技能来协调前后端开发，确保项目的顺利进行和高质量交付。如果你有任何问题或需要进一步的帮助，请随时告诉我。