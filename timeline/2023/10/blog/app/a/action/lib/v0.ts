...
// import { safe } from "@/lib/client/utils";
// import { getDefaultAvatar } from "@/app/a/utils/avatar";
...
// >;
// export function defAct(schema?: any) {
...
//   // When no schema and no explicit generic is provided, Input defaults to undefined.
//   // That makes middleware ctx.input be `undefined` which matches the runtime: no input available.
//   type Input = TInput;
...
// const demo3 = defAct().pre((c) => {})((c: { id: string }) => c.id); // () => Promise<string>
