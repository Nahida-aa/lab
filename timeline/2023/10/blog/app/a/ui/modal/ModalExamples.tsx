...
import { BugReportDialog, BugReportForm } from "@/app/a/ui/form/dialog/page";
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      ...
      <CardContent className="space-y-4">
          ...
          <Button
            ...
            onClick={() =>
              modal.openModal("custom", {
                title: "反馈问题",
                component: <BugReportForm onOpenChange={modal.setOpen} />,
              })
            }
            className="flex items-center gap-2"
          >
        ...
        <div>
          <Button onClick={modal.showBugReport} className="flex items-center gap-2">
            <Trash2 className="w-4 h-4" />
            反馈问题
          </Button>
        </div>
