...
// import BlogSidebar from './[...slug]/_components/BlogSidebar';
...
// import { getRelatedPosts } from './[...slug]/func';
...
export default function BlogList() {
  ...
  // 获取相关的文章和目录数据
  // const PostTrees = getRelatedPosts('aa')
  ...
  return (
    ...
    <div className="flex">
      <section className='flex flex-1 basis-full max-w-full'>
        ...
        {/* 左侧：文章目录tree */}
        {/* <BlogSidebar PostTrees={PostTrees} /> */}
