        ...
        (function (p) {
          ...
          (function (a) {
            ...
            (function (e) {
              ...
              function s(v) {
                return v.hsla.a === 1
                  ? `hsl(${v.hsla.h}, ${(v.hsla.s * 100).toFixed(2)}%, ${(
                      v.hsla.l * 100
                    ).toFixed(2)}%)`
              ...
              e.formatHSL = s;
              function o(v) {
                return `hsla(${v.hsla.h}, ${(v.hsla.s * 100).toFixed(2)}%, ${(
                  v.hsla.l * 100
                ).toFixed(2)}%, ${v.hsla.a.toFixed(2)})`;
              }
              e.formatHSLA = o;
              function u(v) {
              ...
              function L(v, l = !1) {
                return l && v.rgba.a === 1
                  ...
                  : `#${u(v.rgba.r)}${u(v.rgba.g)}${u(v.rgba.b)}${u(
                      Math.round(v.rgba.a * 255)
                    )}`;
              }
              e.formatHexA = L;
              function N(v) {
    ...
    X(J[21], Z([0, 1]), function (W, n) {
      ...
      class p {
        ...
        remove(r) {
          ...
          if (s)
            return (
              this._map.delete(r), this.removeItem(s), this._size--, s.value
            );
        }
        shift() {
          ...
          const r = this._head;
          return (
            this._map.delete(r.key), this.removeItem(r), this._size--, r.value
          );
        }
        forEach(r, s) {
          const o = this._state;
...
`
    ...
    X(J[6], Z([0, 1, 39, 43]), function (W, n, i, x) {
      ...
      class Q {
        ...
        static getData() {
          return (
            this._data || (this._data = new Set(Q.getRawData())), this._data
          );
        }
    ...
    X(J[24], Z([0, 1, 41, 44]), function (W, n, i, x) {
      ...
      class a {
        ...
        _ComputeDiff(e, h, r, s, o) {
          ...
          return (
            o && (S = this.PrettifyChanges(S)), { quitEarly: u[0], changes: S }
          );
        }
    ...
    X(J[16], Z([0, 1]), function (W, n) {
      ...
      class A {
        ...
        static getKey(f) {
          ...
          return (
            p === void 0 && ((p = this.chrKeys.size), this.chrKeys.set(f, p)), p
          );
        }
        constructor(f, p, c) {
          (this.range = f),
      ...
      class w {
        ...
        [Symbol.asyncIterator]() {
          ...
          return {
            ...
            return: async () => (
              this._onReturn?.(), { done: !0, value: void 0 }
            ),
          };
        }
        static map(C, R) {
      ...
      n.win32 = {
        ...
        basename(l, b) {
          ...
          if (
            ...
            return (
              g === w ? (w = C) : w === -1 && (w = l.length), l.slice(g, w)
            );
          }
          for (y = l.length - 1; y >= g; --y)
            if (u(l.charCodeAt(y))) {
            ...
            get: (y, _) => (
              typeof _ == "string" &&
                ...
                (E(_)
                  ...
                  : _.charCodeAt(0) === 36 &&
                    (y[_] = async (...C) => (
                      await w?.(), this.sendMessage(g, _, C)
                    ))),
              y[_]
            ),
          };
      ...
      function (W, n, i, x, A, d, f, p, c) {
        ...
        class e extends c.MirrorTextModel {
          ...
          getValueInRange(r) {
            ...
            return (
              S.push(this._lines[u].substring(0, r.endColumn - 1)), S.join(s)
            );
          }
          offsetAt(r) {
            return (
